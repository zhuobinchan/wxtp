...
<script type="text/javascript">
	...
	function changeIsGetAwardById(id){
		if(window.confirm("你确定要领取奖品吗？(注意：确定后无法撤销领取)")){
			$.post("adminOtherAwardList_changeIsGetAwardByAId.action", {
				id : id
			}, function(result) {
...
<body>
	<div class="container-fluid">
		<div id="tooBar" style="padding: 10px 0px 0px 10px;">
			...
			<form id="excelForm" action="adminOtherAwardList_exportExcel" method="post" enctype="multipart/form-data">
				...
				<a href="${pageContext.request.contextPath}/resource/人气狮王.xls" class="btn btn-danger"   target= "_self ">数据模版下载，可供参考</a>
			</form>
			<script>
							...
							<tbody>
								<c:forEach items="${results }" var="awardList" varStatus="idx">
									<tr>
										...
										<td style="text-align: center;vertical-align: middle;">${awardList.myUnionId }</td>
